...
export const highlineKeyFactory = {
  detail: (id: string, userId?: string) =>
    userId
      ...
      : (['highline', id, 'detail'] as const),
  favorite: (id: string, userId?: string) =>
    userId
      ? (['highline', id, 'favorite', userId] as const)
      : (['highline', id, 'favorite'] as const),
  list: (userId?: string) =>
    userId ? (['highlines', userId] as const) : (['highlines'] as const),
};
