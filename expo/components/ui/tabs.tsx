    ...
    <TextClassContext.Provider
      ...
      <TabsPrimitive.Trigger
        className={cn(
          ...
          Platform.select({
            web: 'h-full focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:outline-ring inline-flex cursor-default whitespace-nowrap transition-[color,box-shadow] focus-visible:outline-1 focus-visible:ring-[3px] disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0',
            native: 'h-full',
          }),
