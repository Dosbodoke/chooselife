...
const SelectTriggerSkeleton: React.FC = () => (
  <View className="flex flex-row h-10 native:h-12 items-center text-sm justify-between rounded-md border border-input bg-background px-3 py-2 web:ring-offset-background text-muted-foreground web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2 [&>span]:line-clamp-1">
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      'py-1.5 native:pb-2 px-3 pr-2 text-popover-foreground text-sm native:text-base font-semibold',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative web:group flex flex-row w-full web:cursor-default web:select-none items-center rounded-sm py-1.5 native:py-2 px-3 pr-2 web:hover:bg-accent/50 active:bg-accent web:outline-none web:focus:bg-accent',
  ...
  >
    ...
    <View className="absolute right-2 native:right-3.5 flex h-3.5 native:pt-px w-3.5 items-center justify-center">
