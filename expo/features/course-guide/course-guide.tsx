...
import { fetchHighlineBeginnerGuideAccess } from './access';
import { CourseGuideScreen } from './screen';
import { resolveCourseGuideState } from './state';

const COURSE_ACCESS_QUERY_KEY = ['course-access', 'highline-beginner'] as const;

/**
 * Owns the course guide's access lifecycle and renders its current view.
 * Callers only need to mount this feature; authentication, access requests,
 * state resolution, and reader composition stay behind this interface.
 */
