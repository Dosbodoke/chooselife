...
-- '%renewal%'. The wildcard works today but would silently swallow an
-- unrelated future job.
--
-- pg_cron is not assumed to be installed, reusing the guard the stage
-- companion already carries. Jobs are unscheduled by iterating over rows that
